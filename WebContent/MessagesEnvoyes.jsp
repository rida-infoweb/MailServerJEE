...
<input type="submit" value="Se déconnecter" class="text-center text-uppercase text-white btn btn-danger" >
    ...
    <div class="col-sm">
      <a class="text-center text-uppercase text-white btn btn-primary" class=""href="Inbox">Messages reçus</a>
    </div>
  </div>
  </div>
</div>
                <h1 class="text-center text-uppercase text-white mt-2"><span class="badge bg-secondary">Messages envoyés</span></h1>
